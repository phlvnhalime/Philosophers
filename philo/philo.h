...
void					initialized_fork(t_mutex *forks, int nbr_philos);
void					initialized_philos(t_philo *philos, t_table *table,
...
/*CLEAN*/
void					cleanup(char *str, t_table *table, t_mutex *forks);
